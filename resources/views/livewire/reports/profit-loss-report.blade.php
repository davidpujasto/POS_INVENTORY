        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($sales_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($sale_returns_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($profit_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($purchases_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($purchase_returns_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($expenses_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($payments_received_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($payments_sent_amount) }}</div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        <div class="text-value text-info">{{ format_currency($payments_net_amount) }}</div>
